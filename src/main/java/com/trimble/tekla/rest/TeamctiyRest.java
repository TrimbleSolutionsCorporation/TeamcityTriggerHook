...
public class TeamctiyRest {
   ...
   * curl --verbose --silent --user admin:admin --request GET --url 'http://localhost:7990/bitbucket/rest/teamcity/latest/projects/PROJECT_1/repos/rep_1/loadhtml?page=index.js' --header 'Accept: application/json' --header 'X-Atlassian-Token: no-check'
